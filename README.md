...
- 👤 Je m'appelle José. Je suis un développeur, humain et rêveur.
- 🛠️ J'aime bricoler les choses. Faire quelque chose de meilleur qu’il ne l’est ou créer quelque chose de entièrement nouveau à partir de zéro.
- ⛵ J'apprécie les nouvelles expériences. Aussi simple ou étrange soit-il, si c'est quelque chose d'intéressant à explorer, alors c'est aussi quelque chose avec lequel il vaut la peine de passer un bon moment.
...
- 👤 I'm Joe. A developer, human and daydreamer.
- 🛠️ I like tinkering with things. To make something better than it is or create something new entirely from scratch.
